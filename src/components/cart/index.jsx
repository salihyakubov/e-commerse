...
import { deleteItemsInCart } from '../../redux/cart/cartSlice';
...
const Cart = ({CartShow,setCartShow}) => {
    ...
    const handleClearCart = () => {
      dispatch(deleteItemsInCart()); // Вызываем функцию для очистки корзины
    };
      ...
      <div class="rounded-lg ">
        {
          ...
          <img src={item.image} alt="product-image" class="w-full rounded-lg sm:w-20" />
        ...
        {itemInCart ? <button style={{ cursor: 'pointer' }} onClick={handleClearCart} className="bg-indigo-600 px-8 py-2 mt-4 rounded-3xl text-white font-semibold uppercase">Clear Cart</button> : ''}
